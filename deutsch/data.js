...
const DEUTSCH_THEMEN = [
  {
    ...
    aufgaben: [
      ...
      ...[
        ["Wolke", true], ["schnell", false], ["Häuser", true], ["Kiste", true],
      ...
      { typ: "mc", frage: "Welches Wort ergibt zusammen mit „Brief“ ein sinnvolles Nomen?", optionen: ["Marke", "Baum", "Fenster"], richtig: 0 },
      { typ: "mc", frage: "Welches Wort ergibt zusammen mit „schreiben“ ein sinnvolles Nomen?", optionen: ["Heft", "Marke", "Fenster"], richtig: 0 },
      { typ: "mc", frage: "Welches Wort ergibt zusammen mit „Birne“ ein sinnvolles Nomen?", optionen: ["Baum", "Heft", "Fenster"], richtig: 0 },
      { typ: "mc", frage: "Welches Wort ergibt zusammen mit „Dach“ ein sinnvolles Nomen?", optionen: ["Fenster", "Buch", "Baum"], richtig: 0 },
      { typ: "mc", frage: "Welches Wort ergibt zusammen mit „lesen“ ein sinnvolles Nomen?", optionen: ["Buch", "Marke", "Fenster"], richtig: 0 },
      ...
      { typ: "mc", frage: "Satzanfang: \"___ er morgen?\" — wie schreibt man das erste Wort?", optionen: ["Kommt", "kommt"], richtig: 0 },
      { typ: "mc", frage: "Mitten im Satz: \"Ich glaube, ___ kommt.\" — wie schreibt man das Wort hier?", optionen: ["er", "Er"], richtig: 0 },
      { typ: "mc", frage: "Mitten im Satz: \"Schau mal, ___ regnet es schon wieder.\" — wie schreibt man das Wort hier?", optionen: ["und", "Und"], richtig: 0 },
...

  {
    ...
    aufgaben: [
      ...
      { typ: "mc", frage: "\"Die Rakete fliegt ins Blaue.\" — Nomen oder Adjektiv?", optionen: ["Nomen", "Adjektiv"], richtig: 0 },
      { typ: "mc", frage: "\"Der blaue Himmel ist schön.\" — Nomen oder Adjektiv?", optionen: ["Nomen", "Adjektiv"], richtig: 1 },
      ...
      { typ: "mc", frage: "Unsere Lehrerin glaubt an das ___ in den Menschen.", optionen: ["Gute", "gute", "Guten"], richtig: 0 },
      { typ: "mc", frage: "Das ___ an den Ferien ist das Nichtstun.", optionen: ["schöne", "Schöne", "Schönes"], richtig: 1 },
      { typ: "mc", frage: "Max hatte nichts ___ zu erzählen.", optionen: ["Neues", "neues", "Neue"], richtig: 0 },
      { typ: "mc", frage: "Die ___ sassen auf der Bank und erzählten.", optionen: ["Alten", "alten", "Alte"], richtig: 0 },
      { typ: "mc", frage: "Ich würde gerne etwas ___ trinken.", optionen: ["Warmes", "warmes", "Warme"], richtig: 0 },
      { typ: "mc", frage: "Das Ungeheuer kam plötzlich aus dem ___.", optionen: ["Dunklen", "dunklen", "Dunkel"], richtig: 0 },
      { typ: "mc", frage: "Im Krieg ist viel ___ geschehen.", optionen: ["Böses", "böses", "Böse"], richtig: 0 },
      { typ: "mc", frage: "Vor ihm leuchtete das ___ der Ampel.", optionen: ["Rote", "rote", "Roten"], richtig: 0 },
...

  {
    ...
    aufgaben: [
      ...
      // 2) Paar oder paar?
      { typ: "mc", frage: "Ein ___ Wolken ziehen vorbei.", optionen: ["Paar", "paar"], richtig: 1 },
      { typ: "mc", frage: "Zwei Schuhe bilden ein ___.", optionen: ["Paar", "paar"], richtig: 0 },
...

  {
    ...
    aufgaben: [
      ...
      { typ: "mc", frage: "\"Die ___le ist ein Nachtvogel.\" — eu oder äu?", optionen: ["eu", "äu"], richtig: 0 },
...

  {
    ...
    aufgaben: [
      ...
      { typ: "mc", frage: "Welche Schreibweise stimmt (etwas ist tatsächlich so)?", optionen: ["war", "wahr", "waar"], richtig: 1 },
...

  {
    ...
    aufgaben: [
      ...
      // 6) Der harte Kern: beide Schreibweisen klingen am Wortende exakt
      // gleich — nur das Verlängern verrät, welche stimmt.
      { typ: "mc", frage: "Wie schreibt man es richtig?", optionen: ["er schreibt", "er schreipt"], richtig: 0 },
      { typ: "mc", frage: "Wie schreibt man es richtig?", optionen: ["sie klebt", "sie klept"], richtig: 0 },
      { typ: "mc", frage: "Wie schreibt man es richtig?", optionen: ["er fegt", "er fekt"], richtig: 0 },
      { typ: "mc", frage: "Wie schreibt man es richtig?", optionen: ["er sagt", "er sakt"], richtig: 0 },
      { typ: "mc", frage: "Wie schreibt man es richtig?", optionen: ["das Kind", "das Kint"], richtig: 0 },
      { typ: "mc", frage: "Wie schreibt man es richtig?", optionen: ["der Zwerg", "der Zwerk"], richtig: 0 },
      { typ: "mc", frage: "Wie schreibt man es richtig?", optionen: ["der Korb", "der Korp"], richtig: 0 },
      { typ: "mc", frage: "Wie schreibt man es richtig?", optionen: ["gesund", "gesunt"], richtig: 0 },
      { typ: "mc", frage: "Wie schreibt man es richtig?", optionen: ["der Berg", "der Berk"], richtig: 0 },
      { typ: "mc", frage: "Wie schreibt man es richtig?", optionen: ["das Kalb", "das Kalp"], richtig: 0 },
    ],
  },

  {
    ...
    aufgaben: [
      ...
      { typ: "mc", frage: "Er ___ in den Apfel.", optionen: ["biss", "bis"], richtig: 0 },
...

  {
    ...
    aufgaben: [
      ...
      { typ: "mc", frage: "Welche Endung passt zu „Kirsch“?", optionen: ["baum", "stand", "brett"], richtig: 0 },
      { typ: "mc", frage: "Welche Endung passt zu „wirk“?", optionen: ["lich", "bar", "haus"], richtig: 0 },
      { typ: "mc", frage: "Welche Endung passt zu „Abwechs“?", optionen: ["lung", "topf", "tisch"], richtig: 0 },
      { typ: "mc", frage: "Welche Endung passt zu „furcht“?", optionen: ["bar", "lich", "lung"], richtig: 0 },
      { typ: "mc", frage: "Welche Endung passt zu „Nacht“?", optionen: ["tisch", "haus", "stand"], richtig: 0 },
      { typ: "mc", frage: "Welche Endung passt zu „Verkaufs“?", optionen: ["stand", "brett", "topf"], richtig: 0 },
      { typ: "mc", frage: "Welche Endung passt zu „Gewächs“?", optionen: ["haus", "lung", "bar"], richtig: 0 },
      { typ: "mc", frage: "Welche Endung passt zu „Dampfkoch“?", optionen: ["topf", "tisch", "stand"], richtig: 0 },
      { typ: "mc", frage: "Welche Endung passt zu „Sprung“?", optionen: ["brett", "haus", "lich"], richtig: 0 },
      // 4) Komposita mit Obst-/Holz-
      { typ: "mc", frage: "Welches Wort ergibt zusammen mit „Obst“ ein sinnvolles Wort?", optionen: ["Verkäufer", "Fenster", "Brücke"], richtig: 0 },
      { typ: "mc", frage: "Welches Wort ergibt zusammen mit „Obst“ ein sinnvolles Wort?", optionen: ["Schale", "Wolke", "Treppe"], richtig: 0 },
      { typ: "mc", frage: "Welches Wort ergibt zusammen mit „Holz“ ein sinnvolles Wort?", optionen: ["Löffel", "Kaffee", "Wolke"], richtig: 0 },
      { typ: "mc", frage: "Welches Wort ergibt zusammen mit „Holz“ ein sinnvolles Wort?", optionen: ["Schwert", "Suppe", "Wolke"], richtig: 0 },
    ],
  },

  {
    ...
    aufgaben: [
      ...
      { typ: "mc", frage: "___mieten (eine Wohnung an jemanden geben) — welche Vorsilbe?", optionen: ["ver-", "vor-", "voll-"], richtig: 0 },
      { typ: "mc", frage: "___stecken (etwas verbergen) — welche Vorsilbe?", optionen: ["ver-", "vor-", "voll-"], richtig: 0 },
      { typ: "mc", frage: "Die Zeit ist ___bei (zu Ende) — welche Vorsilbe?", optionen: ["ver-", "vor-", "voll-"], richtig: 1 },
      { typ: "mc", frage: "___mittags (zwischen Morgen und Mittag) — welche Vorsilbe?", optionen: ["ver-", "vor-", "voll-"], richtig: 1 },
      { typ: "mc", frage: "___kommen (perfekt, makellos) — welche Vorsilbe?", optionen: ["ver-", "vor-", "voll-"], richtig: 2 },
      { typ: "mc", frage: "___ständig (komplett, lückenlos) — welche Vorsilbe?", optionen: ["ver-", "vor-", "voll-"], richtig: 2 },
      { typ: "mc", frage: "___fach (mehrmals, immer wieder) — welche Vorsilbe?", optionen: ["voll-", "vor-", "viel-"], richtig: 2 },
      { typ: "mc", frage: "___fältig (abwechslungsreich) — welche Vorsilbe?", optionen: ["voll-", "vor-", "viel-"], richtig: 2 },
      { typ: "mc", frage: "___sichtig (nicht leichtsinnig) — welche Vorsilbe?", optionen: ["ver-", "vor-", "voll-"], richtig: 1 },
      { typ: "mc", frage: "___gestern (zwei Tage zurück) — welche Vorsilbe?", optionen: ["ver-", "vor-", "voll-"], richtig: 1 },
      { typ: "mc", frage: "___welken (verdorren, eingehen) — welche Vorsilbe?", optionen: ["ver-", "vor-", "voll-"], richtig: 0 },
      { typ: "mc", frage: "___bringen (eine grosse Leistung schaffen) — welche Vorsilbe?", optionen: ["ver-", "vor-", "voll-"], richtig: 2 },
    ],
  },
...

  {
    ...
    aufgaben: [
      ...
      { typ: "mc", frage: "Gestern ___ war Mama im Kino.", optionen: ["Abend", "abend"], richtig: 0 },
      { typ: "mc", frage: "Ich hoffe, dass ich morgen ___ nicht länger bleiben muss.", optionen: ["Mittag", "mittag"], richtig: 0 },
      { typ: "mc", frage: "Vorgestern ___ waren wir auf dem Schlossweiher.", optionen: ["Nachmittag", "nachmittag"], richtig: 0 },
      { typ: "mc", frage: "Ich bin ___ immer bei meiner Oma.", optionen: ["Nachmittags", "nachmittags"], richtig: 1 },
      { typ: "mc", frage: "Jele und Denis können erst morgen ___ ihre Freunde besuchen.", optionen: ["Nachmittag", "nachmittag"], richtig: 0 },
      { typ: "mc", frage: "Gestern ___ war die Feuerwehr in der Schule.", optionen: ["Morgen", "morgen"], richtig: 0 },
      { typ: "mc", frage: "Wenn ich ___ nicht vorwärts mache, komme ich zu spät.", optionen: ["Morgens", "morgens"], richtig: 1 },
      { typ: "mc", frage: "Heute ___ gibt es Pizza.", optionen: ["Mittag", "mittag"], richtig: 0 },
      { typ: "mc", frage: "Ich dusche immer ___.", optionen: ["morgens", "Morgens"], richtig: 0 },
      { typ: "mc", frage: "Übermorgen ___ treffen wir uns.", optionen: ["Mittag", "mittag"], richtig: 0 },
      // 2) Die Falle: morgen (Tag) vs. Morgen (Tageszeit)
      { typ: "mc", frage: "\"Wir treffen uns ___ um acht Uhr.\"", optionen: ["morgen", "Morgen"], richtig: 0 },
      { typ: "mc", frage: "\"Der ___ war neblig.\"", optionen: ["morgen", "Morgen"], richtig: 1 },
      { typ: "mc", frage: "\"Bis ___!\"", optionen: ["morgen", "Morgen"], richtig: 0 },
      { typ: "mc", frage: "\"Am nächsten ___ regnete es.\"", optionen: ["morgen", "Morgen"], richtig: 1 },
      // 3) Adverb (mit -s, klein) oder Nomen (gross) erkennen
      { typ: "mc", frage: "\"Er kommt ___ vorbei.\"", optionen: ["abends", "Abends"], richtig: 0 },
      { typ: "mc", frage: "\"Heute ___ gehen wir aus.\"", optionen: ["Abend", "abend"], richtig: 0 },
      { typ: "mc", frage: "\"Sie schläft ___ schlecht.\"", optionen: ["nachts", "Nachts"], richtig: 0 },
      { typ: "mc", frage: "\"Übermorgen ___ kommt Besuch.\"", optionen: ["Nacht", "nacht"], richtig: 0 },
    ],
  },
];
