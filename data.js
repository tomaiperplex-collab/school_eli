...
const REGIONEN = [
  {
    ...
    teile: [
      ...
      // Kleine Zusatzfläche für den Höhenzug um Court/Moutier (u.a. Berg
      // Moron, der sich ca. 12 km in West-Ost-Richtung erstreckt), der
      // geografisch zum Verwaltungskreis Jura bernois gehört, aber in
      // unserer stark vereinfachten Haupttrennlinie (lon<7.10) nicht erfasst
      // wird, da er weiter östlich liegt.
      [[47.29,7.16],[47.30,7.22],[47.295,7.29],[47.275,7.33],[47.25,7.31],[47.23,7.27],[47.225,7.21],[47.24,7.17],[47.29,7.16]],
    ],
